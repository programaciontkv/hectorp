...
class Factura_model extends CI_Model {
    ...
    public function facturas_no_enviadas(){
		$sql="select fac_id, fac_clave_acceso, 1 as tipo from erp_factura where fac_estado=6 and fac_estado_correo isnull order by random() limit 1
			";

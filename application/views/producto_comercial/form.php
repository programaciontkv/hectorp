                    ...
                    <tr>
                      <td class="col-sm-5">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                  <div class="form-group <?php if(form_error('mp_n')!=''){ echo 'has-error';}?> ">
                                    <input type="text" class="form-control" maxlength="24" name="mp_n" id="mp_c" value="<?php if(validation_errors()!=''){ echo set_value('mp_n');}else{ echo $producto->mp_n;}?>">
                            ...
                            <tr>
                              <td><label>Precio (sin iva)$:</label></td>
                              <td colspan="2">
                            ...
                            <tr>
                              <td><label>Precio2 sin iva() $:</label></td>
                              <td colspan="2">
                            ...
                            <tr>
                              <td><label>Subsidio $:</label></td>
                              <td colspan="2">
                                  <div class="form-group <?php if(form_error('mp_t')!=''){ echo 'has-error';}?> ">
                                    <input type="text" class="form-control decimal" name="mp_t" id="mp_t" value="<?php if(validation_errors()!=''){ echo set_value('mp_t');}else{ echo $producto->mp_t;}?>">
                                    <?php echo form_error("mp_t","<span class='help-block'>","</span>");?>
                                  </div>
                                </td>
                            </tr>
                            <tr>

<section class="content" class="page-break">
    ...
    <table id="detalle" width="100%" class="table table-bordered table-list table-hover table-striped">
        ...
        <tr>
            ...
            <th style="width:60px">Subsidio</th>
            <th style="width:60px">Precio sin Subsidio</th>
        ...
        <tbody>
            ...
            foreach ($cns_det as $det) {
                if($det->pro_subsidio>0){
                    $sin_subsidio=$det->pro_sin_subsidio;
                }else{
                    $sin_subsidio=0;
                }
                ?>
                <tr>
                    ...
                    <td style="width:75px" class="numerico">
                        <?php echo number_format($det->pro_subsidio, $dec) ?>
                    </td>
                    <td style="width:75px" class="numerico">
                        <?php echo number_format($det->pro_subsidio, $dec) ?>
                    </td>
        ...
        <tbody>
            <tr>
                ...
                <td colspan="5" rowspan="9" valign="top" style="background: #ffffff !important;">
                    <table id="info">
                        <tr>
                            <td></td>
                        </tr>
    ...
    <table width="100%">
        ...
        ?>
            ...
            <td  colspan="2">
                <table id="detalle" width="90%" class="table table-bordered table-list table-hover table-striped">
       
                    <tr>
                        <td><strong>Valor Total Sin Subsidio</strong></td>
                        <td class="numerico">$
                                <?php echo number_format($factura->fac_sin_subsidio, $dec) ?>
                        </td>
                    </tr>
                    <tr>
                        <td><strong>Ahorro por Subsidio (Incluye IVA cuando corresponda)</strong></td>
                        <td class="numerico">$
                                <?php echo number_format($factura->fac_sin_subsidio-$factura->fac_total_valor, $dec) ?>
                        </td>
                    </tr>
